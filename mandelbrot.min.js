...
Za(g, "wheel", function(a) {
  ...
  if (0 !== hb) {
    ...
    1e-28 > Ka || (1e-26 > Ka && !Pa ? (Sa("Zoom level reached"), Pa = !0) : 1e-24 < Ka && (Pa = !1), t = a, u = z, v = la, w = b, A = D, B = H, C = A / x, E = B / y, pa = Ba(), N(), O(), l.drawImage(g, 0, 0), l.translate(c, d), l.scale(fb, gb), l.drawImage(h, 0, 0), l.setTransform(1, 0, 0, 1, 0, 0), k.clearRect(0, 0, x, y));
  }
  hb = 0;
}, 50);
function Sa(a) {
